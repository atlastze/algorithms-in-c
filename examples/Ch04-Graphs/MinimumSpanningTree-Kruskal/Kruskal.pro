...
HEADERS = Vector.h DisjointSet.h EdgeListGraph.h IntegerSequence.h GraphReader.h exception.h

# Defines the source files for the project.
SOURCES = main.c DisjointSet.c EdgeListGraph.c IntegerSequence.c GraphReader.c exception.c
